...
public class CustomExceptionHandler extends ExceptionHandlerWrapper {
    ...
    /**
     * Method to handle the generic exception and take a decision of witch step to take after identify the type of
     * the exception.
     * 
    ...
    private void handleException(FacesContext context) {
        ...
        if (unhandled.hasNext()) {
            ...
            if (Exceptions.is(rootCause, BusinessLogicException.class)) {
                ...
                this.handleConstraintViolationException(context, (ConstraintViolationException) rootCause);
                return;
            }

            // direct to the error page if the exceptions is not in the application model
     ...
     * @param ex the exception to fill the details
     */
    private void handleConstraintViolationException(FacesContext context, ConstraintViolationException ex) {
