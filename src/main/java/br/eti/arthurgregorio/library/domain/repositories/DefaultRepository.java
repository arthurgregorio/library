 ...
 * 
 * Every repository should extend this class to get some features that are not default in the basic Deltaspike
 * implementation
 *
...
public interface DefaultRepository<T extends PersistentEntity> extends EntityRepository<T, Long>, CriteriaSupport<T> {
     ...
     * 
     * To use this method you need to implement {@link #getRestrictions(java.lang.String)} and
     * {@link #getEntityStateProperty()}
     * 
